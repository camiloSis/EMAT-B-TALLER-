...
% ---------- 2.9 Probabilidad ----------
\subsection{Nociones de probabilidad}
...
% ============================================================
\subsection{Aplicación de probabilidad}

% ---------- Contexto del experimento ----------
\subsubsection{Contexto general del experimento}
...
% ---------- Evento compuesto ----------
\subsubsection{Evento compuesto}
...
\begin{enumerate}
    ...
    \item La aplicación de probabilidad permitió contrastar el cálculo de un evento simple (8.33\%) frente a uno compuesto con dependencia entre extracciones (0.76\%), evidenciando cómo la ausencia de reposición modifica el espacio muestral y reduce la probabilidad resultante.
\end{enumerate}
