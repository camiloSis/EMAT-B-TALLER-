...
\textbf{Desarrollo:}
\begin{equation*}
    \bar{x} = \frac{(2)(4)+(5)(4)+(10)(4)+(15)(3)+(22)(3)+(28)(1)+(30)(1)+(40)(2)}{22} = \frac{317}{22} \approx 14.41
\end{equation*}

\textbf{Interpretación:} Los estudiantes de EMAT B dedican en promedio 14 horas programando a la semana.

\subsection*{2. Promedio Ponderado}
\begin{equation*}
    \bar{x}_p = \frac{\sum_{i=1}^{k} w_i \cdot x_i}{\sum_{i=1}^{k} w_i}
\end{equation*}

\textbf{Notación:}
\begin{itemize}
    \item $x_i$: valor de la variable
    \item $w_i$: peso asociado a $x_i$ (en este caso, la frecuencia $f_i$)
\end{itemize}

\textbf{Desarrollo:}

Tomando las frecuencias $f_i$ como los pesos $w_i$ de cada valor:
\begin{equation*}
    \bar{x}_p = \frac{(4)(2)+(4)(5)+(4)(10)+(3)(15)+(3)(22)+(1)(28)+(1)(30)+(2)(40)}{4+4+4+3+3+1+1+2} = \frac{317}{22} \approx 14.41
\end{equation*}

\textbf{Interpretación:} Considerando el peso de cada frecuencia, los estudiantes de EMAT B dedican en promedio 14 horas programando a la semana.

\subsection*{3. Mediana (Md)}
\begin{equation*}
